...
for (var i = 0; evenNumArr.length <= 50; i += 2){
	evenNumArr.push(i);
}
...
*/
var oopsArray = [ 'turn' ,null , 'down' ,null , 'for' ,null , 'what' ];
...
*/
var topQuote = "Say hello to my little friend!";
function findLong(theStr){
...
function cap1stLetter(sentStr){
	var cutStr = sentStr.split(" ");
	sentStr = "";
	for (var i = 0; i < cutStr.length; i++){
		cutStr[i] = cutStr[i].charAt(0).toUpperCase() + cutStr[i].slice(1);
	}
